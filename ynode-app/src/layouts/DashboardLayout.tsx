...
export function DashboardLayout() {
  ...
  return (
    <div className="h-screen bg-black text-foreground flex overflow-hidden selection:bg-primary/20 font-sans">
      ...
      <aside className="hidden lg:flex w-72 flex-col border-r border-white/[0.08] bg-black/60 backdrop-blur-xl h-full flex-shrink-0 z-40">
        ...
        <div className="p-4 border-t border-white/[0.08] bg-black/20 flex-shrink-0">
          <button
            onClick={logout}
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-zinc-500 hover:text-red-400 hover:bg-red-500/5 transition-all group text-sm font-medium"
          >
